const Faq = () => {
  return (
      ...
      <section className="bg-gradient-to-b from-yellow-100 to-blue-200 dark:text-gray-100 flex h-screen justify-center items-center">
<div className="container flex flex-col justify-center p-4 mx-auto md:p-8">
  <p className="p-2 text-lg font-medium tracking-wider text-center uppercase">How it works</p>
  <h2 className="mb-12 text-4xl font-bold leading-none text-center sm:text-5xl">FREQUENTLY ASKED QUESTIONS</h2>
  <div className="grid gap-10 md:gap-8 sm:p-3 md:grid-cols-2 lg:px-12 xl:px-32">
    <div>
      <h3 className="font-semibold" data-cy="faq1heading">Lorem ipsum dolor sit amet.</h3>
