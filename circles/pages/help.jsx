...
import edas from "../public/images/edas.png";
import ageuk from "../public/images/ageuk.jpg";
import heartheros from "../public/images/heartheros.jpg";
import nutriri from "../public/images/nutriri co creation.png";
import silverline from "../public/images/Silver-Line.jpg";
...
export default function Faq ({img, title, description}){
    return (
        ...
        <Image src={image} width={1000}  className="w-screen"/>
        <div className="absolute text-white top-1/2 left-[700px] -translate-x-1/2 -translate-y-1/2">
        <h2 className="text-black text-7xl font-bold mb-10 ">Useful Links & FAQ's</h2>
        <p className="text-black text-2xl">
        This page showcases a range of organisations and charities that provide services 
        relating to Health, Well Being, Loss and more. Click on to visit their website and
...
<Card
        ...
        <section className="bg-gradient-to-b from-yellow-100 to-[#BAE5F3] max-h-full mt-32  pt-60 font-mons">
	<div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8  ">
		...
		<div className="divide-y divide-gray-700 text-xl">
			<div className="py-6 space-y-2 md:grid md:grid-cols-12 md:gap-8 md:space-y-0">
				...
				<p className="md:pl-0 md:col-span-7 text-lg">Your Link worker will give you a pin and you will be able to sign in with it, after that your details will be populated and you can start attending local events..</p>
			</div>
			<div className="py-6 space-y-2 md:grid md:grid-cols-12 md:gap-8 md:space-y-0">
				<h3 className="font-semibold md:col-span-5">How many events can i sign up for?</h3>
				<p className="md:pl-0 md:col-span-7 text-lg ">To sign up for an event, navigate your to the events page where you will see your local events, choose the event you would like to attend the click attending?</p>
			</div>
			<div className="py-6 space-y-2 md:grid md:grid-cols-12 md:gap-8 md:space-y-0">
				<h3 className="font-semibold md:col-span-5">If I can't attend an event can I cancel it?</h3>
				<p className="md:pl-0 md:col-span-7 text-lg">If for whatever reason you are unable to attend an event that you are booked in for, you can cancel at any time before the event by going to the event page, finding the event and clicking cancel.</p>
			</div>
			<div className="py-6 space-y-2 md:grid md:grid-cols-12 md:gap-8 md:space-y-0">
				<h3 className="font-semibold md:col-span-5">If I need additional support and help who should I contact?</h3>
				<p className="md:pl-0 md:col-span-7 text-lg">If you need additional support please contact your assigned Link worker and they can assist you..</p>
			</div>
		</div>
	</div>
</section>
