      ...
      <div className="relative ">
        ...
        <div className="absolute w-[300px] h-[300px] bottom-44">
          ...
          <div className="absolute w-[300px] h-[150px] left-[950px]">
            ...
            <div
              className=" absolute left-[70px] top-[110px] w-50 inline-flex justify-center px-4 py-2  rounded-md transition ease-in-out delay-150 bg-[#FFD862] hover:-translate-y-1 hover:scale-110 hover:bg-[#80BEAF] duration-300 bg-[#FFD862]
"
            >
              {session ? (
                ""
