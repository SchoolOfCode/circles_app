...
import { ChevronDoubleLeft, ChevronLeftIcon, ChevronRightIcon, ChevronDoubleRightIcon } from '@heroicons/react/solid'
import { Button, PageButton } from '../../components/Table/SharedButton'
import { classNames } from '../../components/Table/Utils'
import { SortIcon, SortUpIcon, SortDownIcon } from '../../components/Table/Icons'
...
function Table({ columns, data, newData }) {
  ...
  function handleClick(event) {
    console.log(event.target.innerHTML, "honme")
    
    setIdd(parseInt(event.target.innerHTML))
    // console.log(idd, "id")
...
match()
  ...
  //   let responseUser = await fetch("http://localhost:3000/api/admin", {
  //     method: "POST",
  //     headers: {
