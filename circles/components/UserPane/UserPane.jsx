        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="flex justify-center py-1">
            <div className="flex flex-col justify-evenly text-center">
              ...
              <div className="p-2 bg-yellow-100 rounded-lg my-3">
              ...
              <div className="flex flex-col justify-evenly bg-[#BAE5F3] rounded-lg my-3 pt-2 pb-1">
              ...
              <div className="flex justify-center">
                <Button
                  buttonText="Your past events"
                  handleClick={handlePast}
                />
              </div>
            </div>
          </div>
