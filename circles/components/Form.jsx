                ...
                <div className="absolute top-40 left-2/4 bg-white shadow opacity-95 rounded py-28 lg:px-28 px-8">
                    ...
                    <div className="md:flex items-center mt-12">
                        <div className="md:w-72 flex flex-col">
                            <label for="firstname" className="text-base font-mons font-semibold leading-none text-gray-800">First Name</label>
                        ...
                        <div className="md:w-72 flex flex-col md:ml-6 md:mt-0 mt-4">
                            <label for="surname" className="text-base font-mons font-semibold leading-none text-gray-800">Surname</label>
                    ...
                    <div className="md:flex items-center mt-8">
                        <div className="md:w-72 flex flex-col">
                            <label for="email" className="text-base font-semibold font-mons leading-none text-gray-800">Email Address</label>
                        ...
                        <div className="md:w-72 flex flex-col md:ml-6 md:mt-0 mt-4">
                            <label for="contact" className="text-base font-semibold font-mons leading-none text-gray-800">Contact Number</label>
                    ...
                    <div>
                        <div className="w-full flex flex-col mt-8 mb-20">
                            <label for="message" className="text-base font-semibold font-mons leading-none text-gray-800">Message</label>
