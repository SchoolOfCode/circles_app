...
import Logoblack from "../public/images/LogoBlack 2.png";
	...
	<div className="mt-8 space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
		<div className="grid grid-cols-12">
			...
			<div className="col-span-6 text-center md:text-left md:col-span-3">
				...
				<ul className="lg:text-lg md:text-sm sm:text-sm">
					...
					<li>
						<a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400">Search</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400">Login</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400">Resources and Guidance</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400">Our community</a>
					</li>
                    <li>
						<a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400">Useful Links</a>
					</li>
					<li>
			...
			<div className="col-span-6 text-center md:text-left md:col-span-3">
				<p className="pb-1 lg:text-xl md:text-lg sm:text-sm font-semibold">INFORMATION</p>
				<ul className="lg:text-lg md:text-sm sm:text-sm">
					<li>
						<a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400">Home</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400">Organisation</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400">Media</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400">Connect your business</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400">Blog</a>
                        <li>
						<a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400">Terms and Conditions</a>
					</li>
					</li>
				</ul>
			</div>
		...
		<div className="grid justify-center mt-6 lg:justify-between pl-10 pr-10 pb-14 text-sm text-center dark:text-gray-400 h-14 sm:h-2 md:h-5 lg:-5 w-full bg-[#BAE5F3] sm:bg-none md:bg-none">
			...
			<div className="flex justify-center pt-0 md:pl-20 space-x-4 lg:pt-0 lg:col-end-13 md:col-end-13 sm:col-end-5 ">
				<a rel="noopener noreferrer" href="#" title="Email" className="flex items-center justify-center w-10 h-10 rounded-full dark:bg-[#BAE5F3] dark:text-gray-900 ">
